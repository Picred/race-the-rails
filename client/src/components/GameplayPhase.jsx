...
/**
 * [Renders the planned route, the related events and the coins updated step by step.]
 * @param {Object} props 
 * @returns a component containg the information about the gameplay phase.
 */
export const GameplayPhase = (props) => {
    ...
    const path_len = props.current_path.length;
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            ...
            if (current_step < path_len) {
                set_current_step(prev_step => prev_step + 1);
            }
        }, 3000);

        return () => clearTimeout(timer);
    }, [current_step, current_event, path_len]);
        ...
        <>
            <Stack direction="vertical" gap={5} className="align-items-center">
                ...
                <Button
                    ...
                    disabled={current_event}
                    onClick={() => props.set_current_phase(props.phases.RESULTS)}>
                    Vai ai risultati
                </Button>
            </Stack>
        </>
